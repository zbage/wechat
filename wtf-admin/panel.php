...
<html>
  ...
  <body name="a">
    <div class="main container">
      <ul id="panelTab" class="nav nav-tabs">
        <li>
        <a href="#message">留言</a>
        </li>
        <li>
      ...
      <div class="tab-content">
        <div id="message" class="tab-pane fade in active">
          ...
          <table class="table table-hover table-bordered" id="feedList">
            <thead><tr><td><strong>用户代码</strong></td><td><strong>留言时间</strong></td><td><strong>内容</strong></td></tr></thead>
            <tbody>
<?php 
...
while($row = mysql_fetch_array($sql)){
  ...
  $user = $row['user'];
  $time = $row['time'];
  echo '<li class="message_item"> <div class="message_info"> <div class="message_user"> <strong>'.$user.'</strong>: </div> <div class="message_content"> <p>'.$content.'</p> </div> </div> <div class="message_time"> <span>'.$time.'</span> </div> <div class="message_reply"> <a href="#" class="btn btn-link">回复</a> </div> </li> <hr/>';
}
?>
          </ul>
        </div>
